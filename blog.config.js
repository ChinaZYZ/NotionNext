...
const BLOG = {
  AUTHOR: '盗铃', // 作者
  BIO: '一个乐观的颓废青年⭐', // 作者简介
  LINK: 'www.mucoder.top/about', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:process.env.NOTION_PAGE_ID || 'ae07517b44f8466ca2fbc7048e15ecc6', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
...
//   POST_LIST_PREVIEW:'true',
  ...
  CONTACT_EMAIL: 'kingship_zyz@163.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/ChinaZYZ',
  CONTACT_TELEGRAM: '',
